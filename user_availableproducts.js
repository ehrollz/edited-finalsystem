...
function buyProduct(index) {
    ...
    productName.textContent = `Do you want to buy ${product.product_name}?`;
    ...
    // Close modal when the user clicks "Cancel"
    cancelBuyButton.onclick = closeModal;

    // Handle confirm button click
    confirmBuyButton.onclick = () => {
        let quantityToBuy = parseInt(quantityInput.value);
