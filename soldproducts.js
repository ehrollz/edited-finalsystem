...
document.addEventListener('DOMContentLoaded', display_soldproducts);

//DISPLAY DATA
function display_soldproducts() {
    let results = products.filter(product => product.status === 'OUT OF STOCK');
